...
$obj =new Topimage();
$row=$obj->getImageById("id");

$obj =new Bottomimage();
$Brow=$obj->getBottomImageById("id");

$obj =new Rightimage();
$Rrow=$obj->getRightImageById("id");

$obj =new Leftimage();
$Lrow=$obj->getLeftImageById("id");
...
<title>》⍟☆⍣ Happy New Year ⍣☆⍟《</title>
    ...
    <meta property="og:title" content="तुम जियो हज़ारों साल दिल से बस अब यही दुआ निकले
दूर हो जाऊ उस वक़्त से पहले, जब जिस्म से रूह निकले" />
...
.rightt{
 ...
 <!----- Main Background ------>
<center>	
<div class="cssload-preloader" style="width: 100%; height:590px; center;">
	<div class="cssload-preloader-box" > <div>H</div>		<div>A</div>		<div>P</div>		<div>P</div>		<div>Y</div>		<div>N</div>		<div>E</div>		<div>W</div>		<div>Y</div>		<div>R</div></div>
</div>
</center>
<!-- Sidebar Sliding Images --->
<marquee class="m1" behavior="scroll" direction="up" scrolldelay="5">  <br>
<img src="https://2.bp.blogspot.com/-2r1H8gn-ZTQ/WzrwQAWwrgI/AAAAAAAABHY/5pOc2fQARLMnr6ChWyQDcB_cH1VA2pjWgCPcBGAYYCw/s1600/1.png" height="129px" width="35px"/><br><br>
<img src="https://3.bp.blogspot.com/-kFQ5uMYCLPw/WzrwQNs5WxI/AAAAAAAABHU/dFkq7VlKHnoLkXJvmfMCVAArzUBS0x4nwCPcBGAYYCw/s1600/2.png" height="129px" width="35px"/><br><br>
<img src="https://2.bp.blogspot.com/-2r1H8gn-ZTQ/WzrwQAWwrgI/AAAAAAAABHY/5pOc2fQARLMnr6ChWyQDcB_cH1VA2pjWgCPcBGAYYCw/s1600/1.png" height="129px" width="35px"/><br><br>
<img src="https://3.bp.blogspot.com/-kFQ5uMYCLPw/WzrwQNs5WxI/AAAAAAAABHU/dFkq7VlKHnoLkXJvmfMCVAArzUBS0x4nwCPcBGAYYCw/s1600/2.png" height="129px" width="35px"/><br><br>
<img src="https://2.bp.blogspot.com/-2r1H8gn-ZTQ/WzrwQAWwrgI/AAAAAAAABHY/5pOc2fQARLMnr6ChWyQDcB_cH1VA2pjWgCPcBGAYYCw/s1600/1.png" height="129px" width="35px"/><br><br>
<img src="https://3.bp.blogspot.com/-kFQ5uMYCLPw/WzrwQNs5WxI/AAAAAAAABHU/dFkq7VlKHnoLkXJvmfMCVAArzUBS0x4nwCPcBGAYYCw/s1600/2.png" height="129px" width="35px"/><br><br>
...
<img src="https://3.bp.blogspot.com/-kFQ5uMYCLPw/WzrwQNs5WxI/AAAAAAAABHU/dFkq7VlKHnoLkXJvmfMCVAArzUBS0x4nwCPcBGAYYCw/s1600/2.png" height="129px" width="35px"/><br><br>
 ...
 <center>
<!-- Adsemse ads code 300X50 Wishing Script -->
...
// exit();
  ...
  ?>
<center>
        <img src="<?php echo  substr($row[0]['topimage'] ,3); ?>" height="100px;" width="50%">
     </center>

<?php
}
?>
 <center><span style="color: #ff077a;">▁ ▂ ▄ ▅ Happy New Year ▅ ▄ ▂ ▁</center>
...
<img src="https://1.bp.blogspot.com/-l0EVRb2fd3Q/WyNAg2N6m6I/AAAAAAAAAag/yA795u9GRJIf-DaE6-UCcWxL_bbdR5rXwCLcBGAs/s1600/Snow_falling1.gif" class="swing1" alt="Snow" style="width: 100%; height:80px;">

<p style="text-align: center;"><strong><span style="font-size: 16pt; font-family: 'comic sans ms', 	sans-serif; color: #ff0044;">✡ <span style="font-family: 'trebuchet ms', geneva;">HAPPY NEW YEAR</span> ✡</span></strong></p>
<br> </br>
<!--<h2>Main Center Image</h2>-->


    <div class="container">
        <div class="left_side"><img src="<?php echo  substr($Lrow[0]['leftimage'] ,3); ?>" class="leftt"></div>
        <div class="center">
            <h2> <img src="http://2.bp.blogspot.com/-SxP-ZeV3Wf4/W_E972UPyNI/AAAAAAAABDk/9sb8Dfj9ZssEDW9mCXaqMsDjV57nMW8DQCK4BGAYYCw/s1600/kisspng-logo-brand-font-line-point-happy-new-year-2019-love-png-5b6ac30c9df2b6.104260571533723404647.png" class="img-responsive ix" alt="Main Image" >
            </h2>
            <!----- Wishing Poem Here ----->
            <p style="text-align: center;"><strong><span style="background-color: #ff0000; color: #ffffff; font-size: 18pt; font-family: tahoma, arial, helvetica, sans-serif;">&nbsp;नया सवेरा नयी किरन के साथ  </span></p>
            <p style="text-align: center;"><span style="background-color: #008000; color: #ffffff; font-size: 16pt; font-family: tahoma, arial, helvetica, sans-serif;">&nbsp;नया दिन एक प्यारी सी मुस्कान के साथ, </span></p>
            <p style="text-align: center;"><span style="background-color: #ff00ff; color: #ffffff; font-size: 16pt; font-family: tahoma, arial, helvetica, sans-serif;">&nbsp;आप को नया साल मुबारक हो, </span></p>
            <p style="text-align: center;"><span style="background-color: #00ccff; color: #ffffff; font-size: 16pt; font-family: tahoma, arial, helvetica, sans-serif;">&nbsp;ढ़ेर सारी दुआओं के साथ, </span></p>


            <p style="text-align: center;"><strong><span style="font-size: 14pt; font-family: tahoma, arial, helvetica, sans-serif;"><span style="color: #ff0000;">》⍟☆⍣ Happy New Year ⍣☆⍟《</span></span></strong></p>

            <p style="text-align: center;"><span style="background-color: #ff0000; color: #ffffff; font-size: 16pt; font-family: tahoma, arial, helvetica, sans-serif;">&nbsp;भूल जाओ बीते हुए कल को </span></p>
            <p style="text-align: center;"><span style="background-color: #008000; color: #ffffff; font-size: 16pt; font-family: tahoma, arial, helvetica, sans-serif;">&nbsp;दिल में बसा लो आने वाले कल को  </span></p>
            <p style="text-align: center;"><span style="background-color: #ff00ff; color: #ffffff; font-size: 16pt; font-family: tahoma, arial, helvetica, sans-serif;">&nbsp;मुस्कुराते रहो चाहे जैसा भी हो पल </span></p>
            <p style="text-align: center;"><span style="background-color: #00ccff; color: #ffffff; font-size: 16pt; font-family: tahoma, arial, helvetica, sans-serif;">&nbsp; खुशियाँ लेकर आएगा आने वाला कल..! </span></p>

            <img src="http://3.bp.blogspot.com/-hE11bfzRsZw/W_FDAy0EOOI/AAAAAAAABD8/Ytu-uMvAhREfuuUnpCfBcfpdj25Sx_t9QCK4BGAYYCw/s1600/farwork.gif" class="img-responsive ix" alt="Main Image" >
            <center>
                <!-- Adsense ads code 300X50 Wishing Script -->
            </center>

        </div>
        <div class="right_side"><img src="<?php echo substr($Rrow[0]['rightimage'] ,3); ?>" class="rightt"></div>
...
<center >
	        <center>
        <img src="<?php echo  substr($Brow[0]['bottom_image'] ,3); ?>" height="100px;" width="50%">
	        </center>
<div class="busi"><p style="text-transform: uppercase;font-size: 20px;color:#000000;"> <script type="text/javascript" language="Javascript">
 document.write( "To-" +a);
                      </script><br><img src="http://4.bp.blogspot.com/-b0b6kQXut8w/W_FDA5j5d7I/AAAAAAAABEA/EqjRg3ttC8Mk2m7x9-pHMqXrhZbgs_yEwCK4BGAYYCw/s1600/Happy_New_Year_Banner_Transparent_Clip_Art_Image.png" height="70px" width="400px"/></p>

                  </center>


<center>
<!-- AdSense ads code Here (link ads)-->
    <img  src="http://3.bp.blogspot.com/-Um2Z8zE4e5s/W_FC9_0EfqI/AAAAAAAABDw/cHkP8CWO-8QQPNtnrShMgiBj1ohOnlHiwCK4BGAYYCw/s1600/happy-new-year-png-happy-new-year-png-file-1024.png" height="140px" width="140px"/>
</center>
<p style="text-align: center;"><span style="background-color: #008000; color: #ffffff; font-size: 18pt; font-family: tahoma, arial, helvetica, sans-serif;">&nbsp;यहाँ से share करे  </span></p>

<center><img src="https://4.bp.blogspot.com/-_ZpU-nyCpMc/WyNC8YxwrfI/AAAAAAAAAaw/KXfG3ltVcsgu57_M4_Fa7dZEaRVu1EyGACLcBGAs/s1600/c.gif" height="70px" width="110px"/>
<br></br>
<!---This Theme Edited and Designed By Sachin kumar----->
<br></br>
<center>
 <a class="footerbtn" href="whatsapp://send?text= *Touch the blue line and see the magic* 👉 Your url here">
 <img width="22px" height="22px" src="https://4.bp.blogspot.com/-6JgkC7A349g/WyNAg7x-Y1I/AAAAAAAAAac/MGgA4HQxZI0YA1xQ1aBXa_oTJzWG7Nm7wCLcBGAs/s1600/wp.png"/>
 <b style="font-size: 26px;">Share on Whatsapp</b>
 <img width="25px" height="25px" src="https://4.bp.blogspot.com/-6JgkC7A349g/WyNAg7x-Y1I/AAAAAAAAAac/MGgA4HQxZI0YA1xQ1aBXa_oTJzWG7Nm7wCLcBGAs/s1600/wp.png"/></a>
</center>

<!-- This Script is Provided by: Sachin kumar -->
...
Happy New Year.html
Displaying Happy New Year.html.	