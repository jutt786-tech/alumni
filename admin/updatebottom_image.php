...
if(isset($_POST['save'])) {
     ...
     $name=$_POST['name'];
      $image=$obj->startUpload(); 
           $obj->updateBottomImage($name,$_POST['id'],$image);


           header('location:managebottom_image.php');
           exit();
}
 ?>
<?php   
  ...
  ?>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header text-center">Manage Bottom image</h1>
                </div>
            </div>
            <div class="row">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input1">
                                                    ...
                                                    <input type="file" value="<?php echo $row[0]['topimage'] ; ?>" size="32" name="bottom_image" id="logo" onchange="readURL(this);">
                                                </div>
