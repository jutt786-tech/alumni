...
$obj =new Leftimage();
if(!isset($_POST['save'])) {
    $row = $obj->getLeftImagesById($_GET['id']);
}else
    $row = $obj->getLeftImagesById($_POST['id']);
if(isset($_POST['save'])) {
     $name=$_POST['name'];
      $image=$obj->startUpload(); 
           $obj->updateLeftImage($name,$_POST['id'],$image);
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input1">
                                                    ...
                                                    <input type="file" value="<?php echo $row[0]['leftimage'] ; ?>" size="32" name="leftimage" id="logo" onchange="readURL(this);">
                                                </div>
