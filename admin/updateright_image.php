...
$obj =new Rightimage();
if(!isset($_POST['save'])) {
    $row = $obj->getRightImagesById($_GET['id']);
}else
    $row = $obj->getRightImagesById($_POST['id']);
if(isset($_POST['save'])) {

     $name=$_POST['name'];
      $image=$obj->startUpload(); 
     $R= $obj->Topimage=$_POST['topimage'];
           $obj->updateRightImage($name,$_POST['id'],$image);


           header('location:manageright_image.php');
           exit();
}
 ?>
<?php   
  ...
  ?>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header text-center">Update Rightside image</h1>
                </div>
            </div>
            <div class="row">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input1">
                                                    ...
                                                    <input type="file" value="<?php echo $row[0]['topimage'] ; ?>" size="32" name="rightimage" id="logo" onchange="readURL(this);">
                                                </div>
