...
// Get all post
    ...
    public function addTopImage($name,$topimage) {
        $sql = 'insert into top_img(name,topimage ) values(:name,:topimage)';
        $this->db->query($sql);
        $this->db->bind(':name',$name);
        $this->db->bind(":topimage",$topimage);
  ...
  // GET NEWS BY ID
    public function getImageById($id) {
        $sql = 'select * from top_img  order by id desc';
        $this->db->query($sql);
        $this->db->bind(":id", $id);
        $this->db->execute();
    ...
    public function getImagesById($id) {
        $sql = 'select id,name,topimage from top_img where top_img.id = :id';
        $this->db->query($sql);
        $this->db->bind(":id", $id);
        $this->db->execute();
        return $this->db->resultset();
    ...
    // GET NEWS BY ID
    public function CountTopId($id) {
        $sql = 'select count(id) from top_img order by id';
        $this->db->query($sql);
        $this->db->bind(":id", $id);
        $this->db->execute();
        return $this->db->resultset();
    ...
    public function updateTopImage($name,$id,$topimage) {
        $sql = 'update top_img set name=:name,topimage=:topimage where id=:id';
        $this->db->query($sql);
        $this->db->bind(":id", $id);
        $this->db->bind(":name",$name);
        $this->db->bind(":topimage",$topimage);
    ...
    public function deleteImage($id) {
        $sql= 'DELETE FROM top_img where id=:id';
        $this->db->query($sql);
        $this->db->bind(':id',$id);
        $result=$this->db->execute();
        return $result;
...
//image upload  Function
    ...
    {
        $this->fileName = $_FILES['topimage']['name'];
        $this->tmpName = $_FILES['topimage']['tmp_name'];
